...
namespace MaterialHaloSharp.Special_Controls
{
    ...
    public sealed class CircularProgressBar : UserControl
    {
        ...
        /// <summary>
        /// The progress circle total angle
        /// </summary>
        private int progressCircleTotalAngle;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            try
            {
                ...
                g.FillPie(
                    ...
                    ToRectangle(new RectangleF(point, size)), 
                    this.ProgressCircleStartAngle, 
                    (this.aniValue / (this.MaxValue - this.MinValue)) * this.TotalAngle);
